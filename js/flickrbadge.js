Flickrbadge = new Class({
         ...
         compute: function(o) { 
               ...
               var out = '',
                   list = new Element('ul');
                   $(list).addEvent('click',function(e){this.show(e,id)}.bind(this));
             ...
             var t = $(e.target);
                     if(t.nodeName.toLowerCase() === 'img') { 
                          ...
                          img.addEvent('click',function(e){
                           ...
                           t.getParent('div#'+id).appendChild(img);
                           t.getParent('div#'+id).addClass(this.options.openClass);
                           this.bs[id].img = img;
                     }          
